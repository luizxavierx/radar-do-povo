...
final class CacheKeyFactory
{
     ...
     */
    public static function gastoResumoViagens(
        array $filtro,
    ...
    ): string
    {
        return 'gasto:resumo_viagens:' . self::genericFilterKey($filtro)
            . ':'
            . md5(json_encode([
                'includePagamentos' => $includePagamentos,
                'includeTrechos' => $includeTrechos,
            ], JSON_THROW_ON_ERROR));
    }
     ...
     * @param array<string,mixed> $filtro
     */
    public static function gastoViagensPainel(
        array $filtro,
        int $limit,
        int $offset,
    ...
    {
        $selection = $includeTotal ? 'with_total' : 'without_total';
        return 'gasto:viagens_painel:' . self::genericFilterKey($filtro) . ":{$limit}:{$offset}:{$selection}";
    }

    /**
     * @param array<string,mixed> $filtro
     */
    public static function gastoTopViajantes(
        array $filtro,
        int $limit,
        int $offset,
        bool $includeTotal = true,
    ...
    {
        return 'gasto:top_viajantes:' . self::genericFilterKey($filtro) . ":{$limit}:{$offset}:" . self::rankingSelectionKey($includeTotal, $nodeFields);
    }

    /**
     * @param array<string,mixed> $filtro
     */
    public static function gastoTopGastadoresViagens(
        array $filtro,
        int $limit,
        int $offset,
        bool $includeTotal = true,
    ...
    {
        return 'gasto:top_gastadores_viagens:' . self::genericFilterKey($filtro) . ":{$limit}:{$offset}:" . self::rankingSelectionKey($includeTotal, $nodeFields);
    }

    /**
     * @param array<string,mixed> $filtro
     */
    public static function gastoTopOrgaosSuperioresViagens(
        array $filtro,
        int $limit,
        int $offset,
        bool $includeTotal = true,
    ...
    {
        return 'gasto:top_orgaos_superiores_viagens:' . self::genericFilterKey($filtro) . ":{$limit}:{$offset}:" . self::rankingSelectionKey($includeTotal, $nodeFields);
    }

    /**
     * @param array<string,mixed> $filtro
     */
    public static function gastoTopOrgaosSolicitantesViagens(
        array $filtro,
        int $limit,
        int $offset,
        bool $includeTotal = true,
    ...
    {
        return 'gasto:top_orgaos_solicitantes_viagens:' . self::genericFilterKey($filtro) . ":{$limit}:{$offset}:" . self::rankingSelectionKey($includeTotal, $nodeFields);
    }
    ...
    {
        return 'emenda:top_paises:v2:' . self::genericFilterKey($filtro) . ":{$limit}:{$offset}";
    }
     ...
     */
    private static function rankingSelectionKey(bool $includeTotal, array $nodeFields): string
    {
        $normalizedFields = array_values(array_unique(array_map(
