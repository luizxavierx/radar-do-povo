...
interface GastoRepositoryInterface
{
     ...
     * @return array{nodes: array<int,array<string,mixed>>, total: int}
     */
    public function topViajantes(array $filtro, int $limit, int $offset, bool $includeTotal = true, array $nodeFields = []): array;
     ...
     * @return array{nodes: array<int,array<string,mixed>>, total: int}
     */
    public function topGastadoresViagens(array $filtro, int $limit, int $offset, bool $includeTotal = true, array $nodeFields = []): array;
     ...
     * @return array{nodes: array<int,array<string,mixed>>, total: int}
     */
    public function topOrgaosSuperioresViagens(array $filtro, int $limit, int $offset, bool $includeTotal = true, array $nodeFields = []): array;
     ...
     * @return array{nodes: array<int,array<string,mixed>>, total: int}
     */
    public function topOrgaosSolicitantesViagens(array $filtro, int $limit, int $offset, bool $includeTotal = true, array $nodeFields = []): array;
